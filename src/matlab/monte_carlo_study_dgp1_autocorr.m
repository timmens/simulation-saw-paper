...
for t = 1:nT
    ...
    for n = 1:nN
        ...
        hd2_tmp    = 0;
        parfor r = 1:nSim
            [Y, X1, X2, tau1, tau2, beta1, beta2] = dgp1_autocorr(t_tmp, n_tmp, 0.5, 0.5, 0.5, 0.5, sqrt(0.75));
...
file_name = "simulation-dgp1_autocorr-alt-" + regexprep(regexprep(datestr(datetime), ' ','-'), ':', '-')+ ".csv";
