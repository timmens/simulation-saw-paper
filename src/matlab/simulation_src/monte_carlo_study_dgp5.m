    ...
    for s = 1:nS
        ...
        for n = 1:nN
            ...
            parfor r = 1:nSim
                ...
                [tau_est, alpha_est] = panelpls(Y, X, n_tmp, option, 0); % 1 for mex
...
T = cT(:); S = cS(:); N = cN(:);
result_table = table(T, S, N, s_est_mean, s_est_sd, mise_mean, mise_sd, mdcj_mean, mdcj_sd, hd_mean, hd_sd, s_0); 
