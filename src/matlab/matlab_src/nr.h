...
double brent(double ax, double bx, double cx, const double *R, const int p, const double lam, const double *g, double (*f)(double,const double*, const int, const double, const double*), double tol,
	double *xmin);
...
/*void mnbrak(float *ax, float *bx, float *cx, float *fa, float *fb,
	float *fc, const double *R, const int p, const double lam, const double *g, float (*func)(float,const double*, const int, const double, const double*));*/
